...
Only share benchmark numbers with hardware, OS, daemon config, storage backend, payload size, event count, and whether auth/redaction/compression were enabled.
